  ...
  if (length(alfas)==1) {
    ...
    if (length(alfas)==2) {
      ...
      for (i in 1:(length(alfas)-1)) {
        cat ("la mejor alternativa es",altsinrep[i+1],
             "para alfa perteneciente a [",alfas[i],",",alfas[i+1],"] ") 
      }
      cat ("y la mejor alternativa es", altsinrep[length(altsinrep)], 
...
¿Qué transporte sería la mejor opción (con el que más ahorre) para ir
atrabajar?
